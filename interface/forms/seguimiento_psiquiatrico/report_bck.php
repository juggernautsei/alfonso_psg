...
<b>Re-evaluacion de estado mental del paciente:</b><br>
'.$data['reeval_mental'].'<br>
'.$data['reeval_mental_cmnt'].'
</div>
<div class="form-group col-md-12">
<b>Comentario Adiccional:</b><br>
'.$data['coment_adicc'].'<br>
...
Luego de realizar la evaluación del paciente, se concluye que sus síntomas están asociados a uno o más<br> diagnósticos psiquiátricos reconocidos por el American Psyquiatric Association.<br><br>
'.implode('<br>',explode(';',$data['imp_dia'])).'
</div>
<div class="form-group col-md-12">
<b>Plan</b><br>
Seguimiento psiquiátrico en '.$data['plan'].'
</div>
<div class="form-group col-md-12 formato">
<p>Se recomienda el siguiente régimen de medicamentos:<br></p>
...
<div class="form-group col-md-12">
<b>Cambios reportados en condiciones médicas del paciente:</b><br>
'.$data['cambios'].'
</div>
