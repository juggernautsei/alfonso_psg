  ...
  <div id="tabs" class="row m-0" style="border-top:1px solid black">
    <div class="col-md-3" style="padding-left:0px;width:300px;min-height:1200px;">
      <nav class="nav flex-column" style="min-height:762px;background-color:#337ab7;">
        <!--<li class="active"><a data-toggle="tab" href="#menu1"><i class="glyphicon glyphicon-asterisk"></i>ID/Queja Principal</a></li>
	<li><a data-toggle="tab" href="#menu2"><i class="glyphicon glyphicon-asterisk"></i>Historial de condiciones medicas</a></li>
	<li><a data-toggle="tab" href="#menu3"><i class="glyphicon glyphicon-asterisk"></i>Cirugias o Procedimientos</a></li> -->
        <!--                <li><a data-toggle="tab" href="#menu4"><i class="glyphicon glyphicon-asterisk"></i> Alergias & Medicamentos</a></li>
	<li><a data-toggle="tab" href="#menu5"><i class="glyphicon glyphicon-asterisk"></i> Historial Psiquiatrico</a></li>-->
        <a data-toggle="tab" class="nav-link active" href="#menu6"><i class="fa fa-certificate"></i> Examen Mental</a>
    ...
    <div class="col-md-9 enc-form">
      <form class="" name="seguimiento_form" role="form" method="post" action="<?php echo $rootdir; ?>/forms/seguimiento_psiquiatrico/save.php?<?php echo (isset($_REQUEST['id']) && $_REQUEST['id'] != '') ? ('mode=edit&id=' . $_REQUEST['id']) : 'mode=new'; ?>" enctype="multipart/form-data">
        ...
        if (isset($_REQUEST['id']) && $_REQUEST['id'] != '') {
          ...
          $data1 = sqlStatement("select * from seguimiento_medicamento1 where form_id=?", array($_REQUEST['id']));
          $drugs_code1 = [];
          while ($row = sqlFetchArray($data1)) {
            array_push($drugs_code1, $row);
          }
          $data2 = sqlStatement("select * from seguimiento_medicamento2 where form_id=?", $_REQUEST['id']);
          $drugs_code = [];
          while ($row = sqlFetchArray($data2)) {
            array_push($drugs_code, $row);
          }
        } else if (isset($_REQUEST['get_pre_value']) && $_REQUEST['get_pre_value'] != '') {
          $data = sqlQuery("select sp.* from form_seguimiento_psiquiatrico sp left join forms f on f.form_id=sp.id and f.formdir='seguimiento_psiquiatrico' and sp.pid=f.pid where sp.pid=" . $pid . " and f.deleted=0 order by sp.date desc,sp.id desc limit 1");
          $drugs_code1 = [];
          $drugs_code = [];
          if (!empty($data)) {
            $data1 = sqlStatement("select * from seguimiento_medicamento1 where form_id=?", array($data['id']));
            while ($row = sqlFetchArray($data1)) {
              array_push($drugs_code1, $row);
            }
            $data2 = sqlStatement("select * from seguimiento_medicamento2 where form_id=?", $data['id']);
            while ($row = sqlFetchArray($data2)) {
              array_push($drugs_code, $row);
            }
          }
            ...
            <div class="col-md-12 in-content">
              ...
              <div class="form-group col-md-12">
                <label class="form-check-label col-md-3" for="gridCheck">
                  ...
                  <br>para cuido o residencia a largo plazo
                </label>
                <div class="col-md-9" style="display:flex">
            ...
            <div class="col-md-12 in-content">
              <div class="form-row form-inline">
                ...
                <div class="form-group col-md-12">
                  ...
                  <label for="inputPassword4">Demencia Alzheimor</label><br>
            ...
            <div class="col-md-12 in-content">
              <div>
                ...
                <div class="form-group col-md-12">
                  ...
                  <textarea class="col-md-12" rows="3" name="alergias"><?php echo $data['alergias']; ?></textarea>
                </div>
                <div class="form-group col-md-12"></div>
		      ...
		      <div class='col-md-12' style='padding-bottom:10px;'> -->
                        <tr class="rowdrug_1 first_primary">
                          <td><input class="drug_align protoautosuggest ui-autocomplete-input drug_code_search" name="prescription1[<?php echo $key; ?>][medicamento]" placeholder="Medicamento" autocomplete="off" type="text" value='<?php echo $dc['medicamento'] ?>'>
                            ...
                            <input class="prescription1_id" name="prescription1_id" type="hidden" value="<?php echo $dc['id'] ?>">
                          </td>
                          <td><input class="drug_concentration drug_align" name="prescription1[<?php echo $key; ?>][dosis]" value="<?php echo $dc['dosis']; ?>"></td>
                          <td style="display:flex"><input class="drug_concentration drug_align form-control" name="prescription1[<?php echo $key; ?>][size]" value="<?php echo $dc['size']; ?>">
                            ...
                            <select class="form-control" name="prescription1[<?php echo $key; ?>][unit]" id="unit">
                              ...
                              <!--<option label="mg/1cc" value="2"  <?php //echo (($dc['unit'] == '2') ? "selected" : "") 
                                                                    ?>>mg/1cc</option>
<option label="mg/2cc" value="3"  <?php //echo (($dc['unit'] == '3') ? "selected" : "") 
                                  ?>>mg/2cc</option>
<option label="mg/3cc" value="4"  <?php //echo (($dc['unit'] == '4') ? "selected" : "") 
                                  ?>>mg/3cc</option>
<option label="mg/4cc" value="5"  <?php //echo (($dc['unit'] == '5') ? "selected" : "") 
                                  ?>>mg/4cc</option>
<option label="mg/5cc" value="6"  <?php //echo (($dc['unit'] == '6') ? "selected" : "") 
                                  ?>>mg/5cc</option>-->
		    ...
		    <div class="col-md-12" style="padding-bottom:10px;"> -->
                      <tr class="rowdrug_1 first_primary">
                        <td><input class="drug_align protoautosuggest ui-autocomplete-input drug_code_search form-control" name="prescription1[0][medicamento]" placeholder="Medicamento" autocomplete="off" type="text" value=''>
                          ...
                          <input class="id" type="hidden" name="prescription1[0][id]" value="">
                        </td>
                        ...
                        <td style="display:flex;"><input class="form-control" name="prescription1[0][size]" value="" placeholder="Talla">
...
<option label="puff" value="12">puff</option>
                        ...
                        <td>
                          <select class="form-control" name="prescription1[0][route]" id="route">
                            <option label=" " value="0"> </option>
                        ...
                        <td>
                          <select class="form-control interval" name="prescription1[0][interval]" id="interval">
                            <option label=" " value="0"> </option>
              ...
              <div>
                ...
                <div class="form-group col-md-10">
                  <table class="table">
                    <tr>
                      <td>
                        <label>Re-evaluacion de estado mental del paciente</label>
                      </td>
                      <td>
                        <select name="reeval_mental" class="form-control col-md-12">
                          <option value="Re-evaluación de estado mental del paciente" <?php echo (($data['reeval_mental'] == "" || $data['reeval_mental'] == "Re-evaluación de estado mental del paciente") ? "selected" : "") ?>>Re-evaluación de estado mental del paciente</option>
                          <option value="Seguimiento de respuesta a medicamentos recetados en una visita anterior" <?php echo (($data['reeval_mental'] == "Seguimiento de respuesta a medicamentos recetados en una visita anterior") ? "selected" : "") ?>>Seguimiento de respuesta a medicamentos recetados en una visita anterior</option>
                          <option value="Manejo de efectos secundarios a medicamentos" <?php echo (($data['reeval_mental'] == "Manejo de efectos secundarios a medicamentos") ? "selected" : "") ?>>Manejo de efectos secundarios a medicamentos</option>
                          <option value="Manejo de exacerbación de sintomas" <?php echo (($data['reeval_mental'] == "Manejo de exacerbación de sintomas") ? "selected" : "") ?>>Manejo de exacerbación de sintomas</option>
                          <option value="None" <?php echo (($data['reeval_mental'] == "None") ? "selected" : "") ?>>None</option>
                        </select>
                      </td>
                    </tr>
                    <tr>
                      <td><label>Otro</label></td>
                      <td><textarea class="col-md-12" rows="3" name="reeval_mental_cmnt"><?php echo $data['reeval_mental_cmnt']; ?></textarea></td>
                    </tr>
                    <tr>
                      <td><label>Comentario Adiccional</label></td>
                      <td>
                        <select name="coment_adicc" class="form-control col-md-12">
                          <option value="No se reportaron cambios en el paciente respecto a la visita anterior" <?php echo (($data['coment_adicc'] == "" || $data['coment_adicc'] == "No se reportaron cambios en el paciente respecto a la visita anterior") ? "selected" : "") ?>>No se reportaron cambios en el paciente respecto a la visita anterior</option>
                          <option value="Se reportaron cambios en el paciente respecto a la visita anterior" <?php echo (($data['coment_adicc'] == "Se reportaron cambios en el paciente respecto a la visita anterior") ? "selected" : "") ?>>Se reportaron cambios en el paciente respecto a la visita anterior</option>
                        </select>
                      </td>
                    </tr>
                    <tr>
                      <td><label>Otro</label></td>
                      <td><textarea class="col-md-12" rows="3" name="coment_otro_cmnt"><?php echo $data['coment_otro_cmnt']; ?></textarea></td>
                    </tr>
                  </table>
                </div><br>
                <h4>Examen Mental</h4>
                  ...
                  <table class="table">
                    <tr>
                      ...
                      <td>
                        <select name="apariencia" class="form-control">
                          ...
                          <option value="Desaliñada" <?php echo (($data['apariencia'] == "Desaliñada") ? "selected" : "") ?>>Desaliñado/a</option>
                          <option value="Nítida" <?php echo (($data['apariencia'] == "Nítida") ? "selected" : "") ?>>Nítido/a</option>
                    ...
                    <tr>
                      ...
                      <td><select name="actividadm" class="form-control">
                          ...
                          <option value="Retraso Psicomotor" <?php echo (($data['actividadm'] == "Agitada") ? "selected" : "") ?>>Agitado/a</option>
                          <option value="Temblorosa" <?php echo (($data['actividadm'] == "Temblorosa") ? "selected" : "") ?>>Tembloroso/a</option>
                          <option value="Paciente encamada" <?php echo (($data['actividadm'] == "Paciente encamada") ? "selected" : "") ?>>Paciente encamado/a</option>
                          ...
                          <option value="Ambula por sí sola" <?php echo (($data['actividadm'] == "Ambula por sí sola") ? "selected" : "") ?>>Ambula por sí solo/a</option>
                    ...
                    <tr>
                      ...
                      <td>
                        <select class="form-control" name="actitud">
                          ...
                          <option value="Cooperadora" <?php echo (($data['actitud'] == "Cooperadora") ? "selected" : "") ?>>Cooperadoro/a</option>
                          <option value="Hostil" <?php echo (($data['actitud'] == "Hostil") ? "selected" : "") ?>>Hostil</option>
                          <option value="Agresiva" <?php echo (($data['actitud'] == "Agresiva") ? "selected" : "") ?>>Agresivo/a</option>
                          <option value="Reservada" <?php echo (($data['actitud'] == "Reservada") ? "selected" : "") ?>>Reservado/a</option>
                          <option value="Desconfiada" <?php echo (($data['actitud'] == "Desconfiada") ? "selected" : "") ?>>Desconfiado/a</option>
                          <option value="Desinteresada" <?php echo (($data['actitud'] == "Desinteresada") ? "selected" : "") ?>>Desinteresado/a</option>
                    ...
                    <tr>
                      ...
                      <td>
                        <select class="form-control" name="conducta">
                          ...
                          <option value="Lució tranquila durante evaluación" <?php echo (($data['conducta'] == "Lució tranquila durante evaluación") ? "selected" : "") ?>>Lució tranquilo/a durante evaluación</option>
                          <option value="Lució intranquila durante evaluación" <?php echo (($data['conducta'] == "Lució intranquila durante evaluación") ? "selected" : "") ?>>Lució intranquilo/a durante evaluación</option>
                          <option value="Desorganizada" <?php echo (($data['conducta'] == "Desorganizada") ? "selected" : "") ?>>Desorganizado/a</option>
                          ...
                          <option value="Se muestra combativa o con dificultad en controlar impulsos" <?php echo (($data['conducta'] == "Se muestra combativa o con dificultad en controlar impulsos") ? "selected" : "") ?>>Se muestra combativo/a o con dificultad en controlar impulsos</option>
                    ...
                    <tr>
                      ...
                      <td>
                        <select class="form-control" name="habia">
                          ...
                          <option value="Clara" <?php echo (($data['habia'] == "Clara") ? "selected" : "") ?>>Claro/a</option>
                          <option value="Disártrica" <?php echo (($data['habia'] == "Disártrica") ? "selected" : "") ?>>Disártrico/a</option>
                          <option value="Mínima" <?php echo (($data['habia'] == "Mínima") ? "selected" : "") ?>>Mínimo/a</option>
                          <option value="Se mantiene en silencio" <?php echo (($data['habia'] == "Se mantiene en silencio") ? "selected" : "") ?>>Se mantiene en silencio</option>
                          <option value="Pausada" <?php echo (($data['habia'] == "Pausada") ? "selected" : "") ?>>Pausado/a</option>
                          <option value="Apresurada" <?php echo (($data['habia'] == "Apresurada") ? "selected" : "") ?>>Apresurado/a</option>
                          ...
                          <option value="Estropajosa" <?php echo (($data['habia'] == "Estropajosa") ? "selected" : "") ?>>Estropajoso/a</option>
                    ...
                    <tr>
                      ...
                      <td>
                        <select class="form-control" name="talante">
                          ...
                          <option value="Eutímico" <?php echo (($data['talante'] == "Eutímico") ? "selected" : "") ?>>Eutímico/a</option>
                          <option value="Deprimido" <?php echo (($data['talante'] == "Deprimido") ? "selected" : "") ?>>Deprimido/a</option>
                          <option value="Expansivo" <?php echo (($data['talante'] == "Expansivo") ? "selected" : "") ?>>Expansivo/a</option>
                          <option value="Ansioso" <?php echo (($data['talante'] == "Ansioso") ? "selected" : "") ?>>Ansioso/a</option>
                    ...
                    <tr>
                      ...
                      <td>
                        <select class="form-control" name="orientacion">
                          ...
                          <option value="Completamente orientada" <?php echo (($data['orientacion'] == "Completamente orientada") ? "selected" : "") ?>>Completamente orientado/a</option>
                          <option value="Parcialmente orientada" <?php echo (($data['orientacion'] == "Parcialmente orientada") ? "selected" : "") ?>>Parcialmente orientado/a</option>
                          <option value="Orientada sólo en persona" <?php echo (($data['orientacion'] == "Orientada sólo en persona") ? "selected" : "") ?>>Orientado/a sólo en persona</option>
                          <option value="Totalmente desorientada" <?php echo (($data['orientacion'] == "Totalmente desorientada") ? "selected" : "") ?>>Totalmente desorientado/a</option>
                    ...
                    <tr>
                      ...
                      <td>
                        <select class="form-control" name="juicio">
                          ...
                          <option value="other" <?php echo (($data['juicio'] == "other") ? "selected" : "") ?>>Other</option>
                        </select>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        <select class="form-control" name="introspeccion">
                          ...
                          <option value="Confundida" <?php echo (($data['introspeccion'] == "Confundida") ? "selected" : "") ?>>Confundido/a</option>
                        </select>
                      </td>
                ...
                <div class="form-group">
                  <table class="table examen-psiquiatrico-table">
                    <tr>
                      ...
                      <td>
                        <input type="text" name="ep_nombre" class="form-control" value="<?php echo $data['ep_nombre']; ?>" />
                      </td>
                      ...
                      <td>
                        <input type="text" name="ep_edad" class="form-control" value="<?php echo $data['ep_edad']; ?>" />
                      </td>
                      <td>
                        <label>Fecha de servicio &nbsp;&nbsp;&nbsp;</label>
                      </td>
                      <td>
                        <input type="text" name="ep_fecha_de_servicio" class="form-control" value="<?php echo $data['ep_fecha_de_servicio']; ?>" />
                      </td>
                    </tr>
                    <tr>
                      <td>Dx</td>
                      <td colspan="5">
                        <input type="text" name="ep_dx" value="<?php echo $data['ep_dx']; ?>" class="form-control" />
                      </td>
                    </tr>
                    <tr>
                      <td>Subjetivo</td>
                      <td colspan="5">
                        <textarea name="ep_subjetivo" rows="10" class="w-100"><?php echo $data['ep_subjetivo']; ?></textarea>
                      </td>
                    </tr>
                    <tr>
                      <td>Apariencia</td>
                      <td colspan="3">
                        <select name="ep_apariencia_select" class="form-control">
                          ...
                          <option value="Buena Higiene" <?php echo (($data['ep_apariencia_select'] == "Buena Higiene") ? "selected" : "") ?>>Buena Higiene</option>
                          <option value="Desaliñado" <?php echo (($data['ep_apariencia_select'] == "Desaliñado") ? "selected" : "") ?>>Desaliñado</option>
                          <option value="Nítida" <?php echo (($data['ep_apariencia_select'] == "Nítida") ? "selected" : "") ?>>Nítida</option>
                          <option value="Normal para la edad" <?php echo (($data['ep_apariencia_select'] == "Normal para la edad") ? "selected" : "") ?>>
                            Normal para la edad
                          </option>
                        </select>
                      </td>
                      <td colspan="2">
                        <textarea name="ep_apariencia_textarea" rows="3"><?php echo $data['ep_apariencia_textarea']; ?></textarea>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td colspan="3">
                        <select name="ep_actitud_conducta_select" class="form-control">
                          <option value="">--Select--</option>
                          <option value="Cooperadora" <?php echo (($data['ep_actitud_conducta_select'] == "Cooperadora") ? "selected" : "") ?>>Cooperadora</option>
                          <option value="Hostil" <?php echo (($data['ep_actitud_conducta_select'] == "Hostil") ? "selected" : "") ?>>Hostil</option>
                          <option value="Agresivo" <?php echo (($data['ep_actitud_conducta_select'] == "Agresivo") ? "selected" : "") ?>>Agresivo</option>
                          <option value="Reservado" <?php echo (($data['ep_actitud_conducta_select'] == "Reservado") ? "selected" : "") ?>>Reservado</option>
                          <option value="Desinteresado" <?php echo (($data['ep_actitud_conducta_select'] == "Desinteresado") ? "selected" : "") ?>>Desinteresado</option>
                          <option value="Desorganizado" <?php echo (($data['ep_actitud_conducta_select'] == "Desorganizado") ? "selected" : "") ?>>Desorganizado</option>
                          <option value="Se limita a emitir sonidos" <?php echo (($data['ep_actitud_conducta_select'] == "Se limita a emitir sonidos") ? "selected" : "") ?>>
                            Se limita a emitir sonidos
                          </option>
                          <option value="Emplea lenguaje soez o insultos" <?php echo (($data['ep_actitud_conducta_select'] == "Emplea lenguaje soez o insultos") ? "selected" : "") ?>>
                            Emplea lenguaje soez o insultos
                          </option>
                          <option value="Hace comentarios inapropiados" <?php echo (($data['ep_actitud_conducta_select'] == "Hace comentarios inapropiados") ? "selected" : "") ?>>
                            Hace comentarios inapropiados
                          </option>
                          <option value="No contesta preguntas" <?php echo (($data['ep_actitud_conducta_select'] == "No contesta preguntas") ? "selected" : "") ?>>
                            No contesta preguntas
                          </option>
                        </select>
                      </td>
                      <td colspan="2">
                        <textarea name="ep_actitud_conducta_textarea" rows="3"><?php echo $data['ep_actitud_conducta_textarea']; ?></textarea>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td colspan="3">
                        <select name="ep_actividad_motora_select" class="form-control">
                          <option value="">--Select--</option>
                          <option value="Retraso Psicomotor" <?php echo (($data['ep_actividad_motora_select'] == "Retraso Psicomotor") ? "selected" : ""); ?>>Retraso Psicomotor</option>
                          <option value="Agitado" <?php echo (($data['ep_actividad_motora_select'] == "Agitado") ? "selected" : ""); ?>>Agitado</option>
                          <option value="Tembloroso" <?php echo (($data['ep_actividad_motora_select'] == "Tembloroso") ? "selected" : ""); ?>>Tembloroso</option>
                          <option value="Paciente encamado" <?php echo (($data['ep_actividad_motora_select'] == "Paciente encamado") ? "selected" : ""); ?>>Paciente encamado</option>
                          <option value="Paciente en silla de ruedas" <?php echo (($data['ep_actividad_motora_select'] == "Paciente en silla de ruedas") ? "selected" : ""); ?>>Paciente en silla de ruedas</option>
                          <option value="Ambula por sí solo" <?php echo (($data['ep_actividad_motora_select'] == "Ambula por sí solo") ? "selected" : ""); ?>>Ambula por sí solo</option>
                          <option value="Ambula con andador o bastón" <?php echo (($data['ep_actividad_motora_select'] == "Ambula con andador o bastón") ? "selected" : ""); ?>>Ambula con andador o bastón</option>
                          <option value="Ambula con ayuda" <?php echo (($data['ep_actividad_motora_select'] == "Ambula con ayuda") ? "selected" : ""); ?>>Ambula con ayuda</option>
                          <option value="No temblores" <?php echo (($data['ep_actividad_motora_select'] == "No temblores") ? "selected" : ""); ?>>No temblores</option>
                        </select>
                      </td>
                      <td colspan="2">
                        <textarea name="ep_actividad_motora_textarea" rows="3"><?php echo $data['ep_actitud_conducta_textarea']; ?></textarea>
                      </td>
                    </tr>
                    <tr>
                      <td>Habla</td>
                      <td colspan="3">
                        <select name="ep_habla_select" class="form-control">
                          <option value="">--Select--</option>
                          <option value="Clara" <?php echo (($data['ep_habla_select'] == "Clara") ? "selected" : ""); ?>>Clara</option>
                          <option value="Disártrica" <?php echo (($data['ep_habla_select'] == "Disártrica") ? "selected" : ""); ?>>Disártrica</option>
                          <option value="Mínima" <?php echo (($data['ep_habla_select'] == "Mínima") ? "selected" : ""); ?>>Mínima</option>
                          <option value="Pausada" <?php echo (($data['ep_habla_select'] == "Pausada") ? "selected" : ""); ?>>Pausada</option>
                          <option value="Apresurada" <?php echo (($data['ep_habla_select'] == "Apresurada") ? "selected" : ""); ?>>Apresurada</option>
                          <option value="Murmura" <?php echo (($data['ep_habla_select'] == "Murmura") ? "selected" : ""); ?>>Murmura</option>
                          <option value="No habla" <?php echo (($data['ep_habla_select'] == "No habla") ? "selected" : ""); ?>>No habla</option>
                        </select>
                      </td>
                      <td colspan="2">
                        <textarea name="ep_habla_textarea" rows="3"><?php echo $data['ep_habla_textarea']; ?></textarea>
                      </td>
                    </tr>
                    <tr>
                      <td>Talante</td>
                      <td colspan="3">
                        <select name="ep_talante_select" class="form-control">
                          <option value="">--Select--</option>
                          <option value="Eutímico" <?php echo (($data['ep_talante_select'] == "Eutímico") ? "selected" : ""); ?>>Eutímico</option>
                          <option value="Deprimido" <?php echo (($data['ep_talante_select'] == "Deprimido") ? "selected" : ""); ?>>Deprimido</option>
                          <option value="Expansivo" <?php echo (($data['ep_talante_select'] == "Expansivo") ? "selected" : ""); ?>>Expansivo</option>
                          <option value="Ansioso" <?php echo (($data['ep_talante_select'] == "Ansioso") ? "selected" : ""); ?>>Ansioso</option>
                          <option value="Paciente no contestó o no se le entendió" <?php echo (($data['ep_talante_select'] == "Paciente no contestó o no se le entendió") ? "selected" : ""); ?>>
                            Paciente no contestó o no se le entendió
                          </option>
                        </select>
                      </td>
                      <td colspan="2">
                        <textarea name="ep_talante_textarea" rows="3"><?php echo $data['ep_talante_textarea']; ?></textarea>
                      </td>
                    </tr>
                    <tr>
                      <td>Afecto</td>
                      <td colspan="3">
                        <select name="ep_afecto_select" class="form-control">
                          <option value="">--Select--</option>
                          <option value="Amplio" <?php echo (($data['ep_afecto_select'] == "Amplio") ? "selected" : ""); ?>>Amplio</option>
                          <option value="Restringido" <?php echo (($data['ep_afecto_select'] == "Restringido") ? "selected" : ""); ?>>Restringido</option>
                          <option value="Embotado" <?php echo (($data['ep_afecto_select'] == "Embotado") ? "selected" : ""); ?>>Embotado</option>
                          <option value="Lábil" <?php echo (($data['ep_afecto_select'] == "Lábil") ? "selected" : ""); ?>>Lábil</option>
                          <option value="Congruente con estado de ánimo" <?php echo (($data['ep_afecto_select'] == "Congruente con estado de ánimo") ? "selected" : ""); ?>>
                            Congruente con estado de ánimo
                          </option>
                          <option value="Incongruente con su estado de ánimo" <?php echo (($data['ep_afecto_select'] == "Incongruente con su estado de ánimo") ? "selected" : ""); ?>>
                            Incongruente con su estado de ánimo
                          </option>
                        </select>
                      </td>
                      <td colspan="2">
                        <textarea name="ep_afecto_textarea" rows="3"><?php echo $data['ep_afecto_textarea']; ?></textarea>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td colspan="3">
                        <select name="ep_pta_select" class="form-control">
                          <option value="">--Select--</option>
                          <option value="Disturbios perceptuales" <?php echo (($data['ep_pta_select'] == "Disturbios perceptuales") ? "selected" : ""); ?>>Disturbios perceptuales</option>
                          <option value="No" <?php echo (($data['ep_pta_select'] == "No") ? "selected" : ""); ?>>No</option>
                          <option value="Si" <?php echo (($data['ep_pta_select'] == "Si") ? "selected" : ""); ?>>Si</option>
                        </select>
                      </td>
                      <td colspan="2">
                        <textarea name="ep_pta_textarea" rows="3"><?php echo $data['ep_pta_textarea']; ?></textarea>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td colspan="3">
                        <select name="ep_tda_select" class="form-control">
                          <option value="">--Select--</option>
                          <option value="Visual" <?php echo (($data['ep_tda_select'] == "Visual") ? "selected" : ""); ?>>Visual</option>
                          <option value="Auditivo" <?php echo (($data['ep_tda_select'] == "Auditivo") ? "selected" : ""); ?>>Auditivo</option>
                          <option value="Táctil" <?php echo (($data['ep_tda_select'] == "Táctil") ? "selected" : ""); ?>>Táctil</option>
                          <option value="Olfativo" <?php echo (($data['ep_tda_select'] == "Olfativo") ? "selected" : ""); ?>>Olfativo</option>
                          <option value="Somático" <?php echo (($data['ep_tda_select'] == "Somático") ? "selected" : ""); ?>>Somático</option>
                          <option value="Gustativo" <?php echo (($data['ep_tda_select'] == "Gustativo") ? "selected" : ""); ?>>Gustativo</option>
                        </select>
                      </td>
                      <td colspan="2">
                        <textarea name="ep_tda_textarea" rows="3"><?php echo $data['ep_tda_textarea']; ?></textarea>
                      </td>
                    </tr>
                          ...
                          <tr>
                            ...
                            <td>
                              <select name="ep_mi_select" class="form-control">
                                <option value="">--Select--</option>
                                <option value="Preservada" <?php echo (($data['ep_mi_select'] == "Preservada") ? "selected" : ""); ?>>Preservada</option>
                                <option value="Alterada" <?php echo (($data['ep_mi_select'] == "Alterada") ? "selected" : ""); ?>>Alterada</option>
                              </select>
                            </td>
                            <td>
                              <textarea name="ep_mi_textarea" rows="3"><?php echo $data['ep_mi_textarea']; ?></textarea>
                            </td>
                          </tr>
                          <tr>
                            <td>Reciente</td>
                            <td>
                              <select name="ep_mr_select" class="form-control">
                                <option value="">--Select--</option>
                                <option value="Preservada" <?php echo (($data['ep_mr_select'] == "Preservada") ? "selected" : ""); ?>>Preservada</option>
                                <option value="Alterada" <?php echo (($data['ep_mr_select'] == "Alterada") ? "selected" : ""); ?>>Alterada</option>
                              </select>
                            </td>
                            <td>
                              <textarea name="ep_mr_textarea" rows="3"><?php echo $data['ep_mr_textarea']; ?></textarea>
                            </td>
                          </tr>
                          <tr>
                            <td>Remota</td>
                            <td>
                              <select name="ep_mre_select" class="form-control">
                                <option value="">--Select--</option>
                                <option value="Preservada" <?php echo (($data['ep_mre_select'] == "Preservada") ? "selected" : ""); ?>>Preservada</option>
                                <option value="Alterada" <?php echo (($data['ep_mre_select'] == "Alterada") ? "selected" : ""); ?>>Alterada</option>
                              </select>
                            </td>
                            <td>
                              <textarea name="ep_mre_textarea" rows="3"><?php echo $data['ep_mre_textarea']; ?></textarea>
                            </td>
                          </tr>
                        </table>
                      </td>
                    ...
                    <tr>
                      ...
                      <td colspan="3">
                        <select name="ep_cdp_select" class="form-control">
                          <option value="">--Select--</option>
                          <option value="Ideas delirantes" <?php echo (($data['ep_cdp_select'] == "Ideas delirantes") ? "selected" : ""); ?>>Ideas delirantes</option>
                          <option value="Obsesiones" <?php echo (($data['ep_cdp_select'] == "Obsesiones") ? "selected" : ""); ?>>Obsesiones</option>
                          <option value="Miedos irracionales" <?php echo (($data['ep_cdp_select'] == "Miedos irracionales") ? "selected" : ""); ?>>Miedos irracionales</option>
                          <option value="Gira en torno a preocupaciones de su diario vivir" <?php echo (($data['ep_cdp_select'] == "Gira en torno a preocupaciones de su diario vivir") ? "selected" : ""); ?>>
                            Gira en torno a preocupaciones de su diario vivir
                          </option>
                          <option value="No trae preocupaciones durante la entrevista" <?php echo (($data['ep_cdp_select'] == "No trae preocupaciones durante la entrevista") ? "selected" : ""); ?>>
                            No trae preocupaciones durante la entrevista
                          </option>
                          <option value="Paciente no contestó o no se entendió" <?php echo (($data['ep_cdp_select'] == "Paciente no contestó o no se entendió") ? "selected" : ""); ?>>
                            Paciente no contestó o no se entendió
                          </option>
                          <option value="Respuestas no guardan relevancia con preguntas o temas tratados" <?php echo (($data['ep_cdp_select'] == "Respuestas no guardan relevancia con preguntas o temas tratados") ? "selected" : ""); ?>>
                            Respuestas no guardan relevancia con preguntas o temas tratados
                          </option>
                          <option value="Confabula" <?php echo (($data['ep_cdp_select'] == "Confabula") ? "selected" : ""); ?>>Confabula</option>
                          <option value="Paciente no contestó o no se le entendió" <?php echo (($data['ep_cdp_select'] == "Paciente no contestó o no se le entendió") ? "selected" : ""); ?>>
                            Paciente no contestó o no se le entendió
                          </option>
                        </select>
                      </td>
                      <td colspan="2">
                        <textarea name="ep_cdp_textarea" rows="3"><?php echo $data['ep_cdp_textarea']; ?></textarea>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td colspan="3">
                        <select name="ep_is_select" class="form-control">
                          <option value="">--Select--</option>
                          <option value="Niega ideas suicidas" <?php echo (($data['ep_is_select'] == "Niega ideas suicidas") ? "selected" : ""); ?>>
                            Niega ideas suicidas
                          </option>
                          <option value="Sin plan Estructurado" <?php echo (($data['ep_is_select'] == "Sin plan Estructurado") ? "selected" : ""); ?>>
                            Sin plan Estructurado
                          </option>
                          <option value="Con plan estructurado" <?php echo (($data['ep_is_select'] == "Con plan estructurado") ? "selected" : ""); ?>>
                            Con plan estructurado
                          </option>
                          <option value="Paciente no habla" <?php echo (($data['ep_is_select'] == "Paciente no habla") ? "selected" : ""); ?>>
                            Paciente no habla
                          </option>
                        </select>
                      </td>
                      <td colspan="2">
                        <textarea name="ep_is_textarea" rows="3"><?php echo $data['ep_is_textarea']; ?></textarea>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td colspan="3">
                        <select name="ep_ih_select" class="form-control">
                          <option value="">--Select--</option>
                          <option value="Niega ideas homicidas" <?php echo (($data['ep_ih_select'] == "Niega ideas homicidas") ? "selected" : ""); ?>>
                            Niega ideas homicidas
                          </option>
                          <option value="Sin plan Estructurado" <?php echo (($data['ep_ih_select'] == "Sin plan Estructurado") ? "selected" : ""); ?>>
                            Sin plan Estructurado
                          </option>
                          <option value="Con plan estructurado" <?php echo (($data['ep_ih_select'] == "Con plan estructurado") ? "selected" : ""); ?>>
                            Con plan estructurado
                          </option>
                          <option value="Paciente no habla" <?php echo (($data['ep_ih_select'] == "Paciente no habla") ? "selected" : ""); ?>>
                            Paciente no habla
                          </option>
                        </select>
                      </td>
                      <td colspan="2">
                        <textarea name="ep_ih_textarea" rows="3"><?php echo $data['ep_ih_textarea']; ?></textarea>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td colspan="3">
                        <select name="ep_pdp_select" class="form-control">
                          <option value="">--Select--</option>
                          <option value="Coherente" <?php echo (($data['ep_pdp_select'] == "Coherente") ? "selected" : ""); ?>>Coherente</option>
                          <option value="Incoherente" <?php echo (($data['ep_pdp_select'] == "Incoherente") ? "selected" : ""); ?>>Incoherente</option>
                          <option value="Lógico" <?php echo (($data['ep_pdp_select'] == "Lógico") ? "selected" : ""); ?>>Lógico</option>
                          <option value="Ilógico" <?php echo (($data['ep_pdp_select'] == "Ilógico") ? "selected" : ""); ?>>Ilógico</option>
                          <option value="Realista" <?php echo (($data['ep_pdp_select'] == "Realista") ? "selected" : ""); ?>>Realista</option>
                          <option value="No realista" <?php echo (($data['ep_pdp_select'] == "No realista") ? "selected" : ""); ?>>No realista</option>
                          <option value="Relevante" <?php echo (($data['ep_pdp_select'] == "Relevante") ? "selected" : ""); ?>>Relevante</option>
                          <option value="No relevante" <?php echo (($data['ep_pdp_select'] == "No relevante") ? "selected" : ""); ?>>No relevante</option>
                          <option value="No habla" <?php echo (($data['ep_pdp_select'] == "No habla") ? "selected" : ""); ?>>No habla</option>
                        </select>
                      </td>
                      <td colspan="2">
                        <textarea name="ep_pdp_textarea" rows="3"><?php echo $data['ep_pdp_textarea']; ?></textarea>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td colspan="3">
                        <select name="ep_nda_select" class="form-control">
                          <option value="">--Select--</option>
                          <option value="Centrada en los temas tratados" <?php echo (($data['ep_nda_select'] == "Centrada en los temas tratados") ? "selected" : ""); ?>>
                            Centrada en los temas tratados
                          </option>
                          <option value="Hiper vigilante" <?php echo (($data['ep_nda_select'] == "Hiper vigilante") ? "selected" : ""); ?>>
                            Hiper vigilante
                          </option>
                          <option value="Se distrae fácilmente con estímulos irrelevantes" <?php echo (($data['ep_nda_select'] == "Se distrae fácilmente con estímulos irrelevantes") ? "selected" : ""); ?>>
                            Se distrae fácilmente con estímulos irrelevantes
                          </option>
                        </select>
                      </td>
                      <td colspan="2">
                        <textarea name="ep_nda_textarea" rows="3"><?php echo $data['ep_nda_textarea']; ?></textarea>
                      </td>
                    </tr>
                    <tr>
                      <td>Orientación</td>
                          ...
                          <tr>
                            ...
                            <td>
                              <select name="ep_ot_select" class="form-control">
                                <option value="">--Select--</option>
                                <option value="Si" <?php echo (($data['ep_ot_select'] == "Si") ? "selected" : ""); ?>>Si</option>
                                <option value="No" <?php echo (($data['ep_ot_select'] == "No") ? "selected" : ""); ?>>No</option>
                              </select>
                            </td>
                            <td>
                              <textarea name="ep_ot_textarea" rows="3"><?php echo $data['ep_ot_textarea']; ?></textarea>
                            </td>
                          </tr>
                          <tr>
                            <td>Lugar</td>
                            <td>
                              <select name="ep_ol_select" class="form-control">
                                <option value="">--Select--</option>
                                <option value="Si" <?php echo (($data['ep_ol_select'] == "Si") ? "selected" : ""); ?>>Si</option>
                                <option value="No" <?php echo (($data['ep_ol_select'] == "No") ? "selected" : ""); ?>>No</option>
                              </select>
                            </td>
                            <td>
                              <textarea name="ep_ol_textarea" rows="3"><?php echo $data['ep_ol_textarea']; ?></textarea>
                            </td>
                          </tr>
                          <tr>
                            <td>Persona</td>
                            <td>
                              <select name="ep_op_select" class="form-control">
                                <option value="">--Select--</option>
                                <option value="Si" <?php echo (($data['ep_op_select'] == "Si") ? "selected" : ""); ?>>Si</option>
                                <option value="No" <?php echo (($data['ep_op_select'] == "No") ? "selected" : ""); ?>>No</option>
                              </select>
                            </td>
                            <td>
                              <textarea name="ep_op_textarea" rows="3"><?php echo $data['ep_op_textarea']; ?></textarea>
                            </td>
                          </tr>
                        </table>
                      </td>
                    ...
                    <tr>
                      ...
                      <td colspan="3">
                        <select name="ep_concentracion_select" class="form-control">
                          <option value="">--Select--</option>
                          <option value="Adecuada" <?php echo (($data['ep_concentracion_select'] == "Adecuada") ? "selected" : ""); ?>>Adecuada</option>
                          <option value="Disminuida" <?php echo (($data['ep_concentracion_select'] == "Disminuida") ? "selected" : ""); ?>>Disminuida</option>
                        </select>
                      </td>
                      <td colspan="2">
                        <textarea name="ep_concentracion_textarea" rows="3"><?php echo $data['ep_concentracion_textarea']; ?></textarea>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td colspan="3">
                        <select name="ep_julicio_select" class="form-control">
                          <option value="">--Select--</option>
                          <option value="Adecuado" <?php echo (($data['ep_julicio_select'] == "Adecuado") ? "selected" : ""); ?>>Adecuado</option>
                          <option value="Superficial" <?php echo (($data['ep_julicio_select'] == "Superficial") ? "selected" : ""); ?>>Superficial</option>
                          <option value="Pobre" <?php echo (($data['ep_julicio_select'] == "Pobre") ? "selected" : ""); ?>>Pobre</option>
                          <option value="Ninguno" <?php echo (($data['ep_julicio_select'] == "Ninguno") ? "selected" : ""); ?>>Ninguno</option>
                        </select>
                      </td>
                      <td colspan="2">
                        <textarea name="ep_julicio_textarea" rows="3"><?php echo $data['ep_julicio_textarea']; ?></textarea>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td colspan="3">
                        <select name="ep_introspeccion_select" class="form-control">
                          <option value="">--Select--</option>
                          <option value="Consciente de sus problemas o situaciones" <?php echo (($data['ep_introspeccion_select'] == "Consciente de sus problemas o situaciones") ? "selected" : ""); ?>>
                            Consciente de sus problemas o situaciones
                          </option>
                          <option value="No está consciente de sus problemas o situaciones" <?php echo (($data['ep_introspeccion_select'] == "No está consciente de sus problemas o situaciones") ? "selected" : ""); ?>>
                            No está consciente de sus problemas o situaciones
                          </option>
                          <option value="Tiene alguna consciencia de sus problemas o situaciones" <?php echo (($data['ep_introspeccion_select'] == "Tiene alguna consciencia de sus problemas o situaciones") ? "selected" : ""); ?>>
                            Tiene alguna consciencia de sus problemas o situaciones
                          </option>
                          <option value="Confundido" <?php echo (($data['ep_introspeccion_select'] == "Confundido") ? "selected" : ""); ?>>
                            Confundido
                          </option>
                        </select>
                      </td>
                      <td colspan="2">
                        <textarea name="ep_introspeccion_textarea" rows="3"><?php echo $data['ep_introspeccion_textarea']; ?></textarea>
                      </td>
                    </tr>
                    <tr>
                      <td>Medicación</td>
                      <td colspan="5">
                        <textarea name="ep_medicacion_text" rows="5" class="w-100"><?php echo $data['ep_medicacion_text']; ?></textarea>
                      </td>
                    </tr>
                    <tr class="pt-5">
                      <td>Firma</td>
                      <td colspan="2">
                        <input type="text" name="ep_firma_input" value="<?php echo $data['ep_firma_input']; ?>" class="form-control" />
                      </td>
                      <td colspan="3"></td>
                    </tr>
                    <tr class="pt-5">
              ...
              <div>
                ...
                <div class="form-group col-md-12">
                  ...
                  <table class="table">
                    <tr>
                      <td class="col-md-3">
                        <label>Seguimiento psiquiátrico en:</label>
                      </td>
                      <td>
                        <select name="plan" class="form-control col-md-4">
                          <option value="1 mes" <?php echo (($data['plan'] == "1 mes") ? "selected" : "") ?>>1 mes</option>
                          <option value="2 meses" <?php echo (($data['plan'] == "2 meses") ? "selected" : "") ?>>2 meses</option>
                          <option value="3 meses" <?php echo (($data['plan'] == "3 meses") ? "selected" : "") ?>>3 meses</option>
                        </select>
                      </td>
                    </tr>
                  </table>
		      ...
		      <div class='col-md-12' style='padding-bottom:10px;'> -->
                        <tr class="rowdrug_1 first_primary">
                          <td><input class="drug_align protoautosuggest ui-autocomplete-input drug_code_search" name="prescription[<?php echo $key; ?>][medicamento]" placeholder="Medicamento" autocomplete="off" type="text" value='<?php echo $dc['medicamento'] ?>'>
                            ...
                            <input class="prescription_id" name="prescription_id" type="hidden" value="<?php echo $dc['id'] ?>">
                          </td>
                          <td><input class="drug_concentration drug_align" name="prescription[<?php echo $key; ?>][dosis]" value="<?php echo $dc['dosis']; ?>"></td>
                          <td style="display:flex"><input class="drug_concentration drug_align form-control" name="prescription[<?php echo $key; ?>][size]" value="<?php echo $dc['size']; ?>">
		    ...
		    <div class="col-md-12" style="padding-bottom:10px;"> -->
                      <tr class="rowdrug_1 first_primary">
                        <td><input class="drug_align protoautosuggest ui-autocomplete-input drug_code_search" name="prescription[0][medicamento]" placeholder="Medicamento" autocomplete="off" type="text" value=''>
                          ...
                          <input class="id" type="hidden" name="prescription[0][id]" value="">
                        </td>
                        ...
                        <td style="display:flex;"><input class="form-control" name="prescription[0][size]" value="" placeholder="Talla">
...
<option label="puff" value="12">puff</option>
                        ...
                        <td>
                          <select class="form-control" name="prescription[0][route]" id="route">
                            <option label=" " value="0"> </option>
                            <option label="Per Oris" value="1">Per Oris</option>
                            <option label="Per Rectum" value="2">Per Rectum</option>
                            <option label="To Skin" value="3">To Skin</option>
                        ...
                        <td>
                          <select class="form-control interval" name="prescription[0][interval]" id="interval">
                            <option label=" " value="0"> </option>
                            <option label="b.i.d." value="1">b.i.d.</option>
                            <option label="t.i.d." value="2">t.i.d.</option>
                            <option label="q.i.d." value="3">q.i.d.</option>
...
<td><textarea class="special_instructions" style="margin-right:10px; height:60px;width:190px !important;margin-top:5px;" name="prescription[0][special_instructions]"></textarea></td>
                ...
                <div class="form-group col-md-11">
                  <table class="table">
                    <tr>
                      <td>
                        <label>Cambios reportados en condiciones médicas del paciente</label>
                      </td>
                      <td>
                        <select name="cambios" class="form-control col-md-12">
                          <option value="Se reportaron cambios en condiciones médicas del paciente respecto a la visita anterior" <?php echo (($data['cambios'] == "" || $data['cambios'] == "Se reportaron cambios en condiciones médicas del paciente respecto a la visita anterior") ? "selected" : "") ?>>Se reportaron cambios en condiciones médicas del paciente respecto a la visita anterior</option>
                          <option value="No se reportaron cambios en condiciones médicas del paciente respecto a la visita anterior" <?php echo (($data['cambios'] == "No se reportaron cambios en condiciones médicas del paciente respecto a la visita anterior") ? "selected" : "") ?>>No se reportaron cambios en condiciones médicas del paciente respecto a la visita anterior</option>
                        </select>
                      </td>
                    </tr>
                  </table>
