...
<?php Header::setupHeader(['common', 'jquery-ui', 'jquery-ui-darkness', 'datetime-picker']);?>
<script>
        ...
        <div class="col-md-3" style="padding-left:0px;width:300px;min-height:1200px;">
            <nav class="nav flex-column" style="min-height:762px;background-color:#337ab7;">
               <a data-toggle="tab" class="nav-link active" href="#menu1"><i class="fa fa-certificate"></i> ID/Queja Principal</a>
                ...
                <a data-toggle="tab" href="#menu3" class="nav-link"><i class="fa fa-certificate"></i> Condiciones Médicas Psiquiátricas</a>
                <a data-toggle="tab" href="#menu4" class="nav-link"><i class="fa fa-certificate"></i> Cirugias o Procedimientos / Condiciones Psiquiátricas</a>
                <a data-toggle="tab" href="#menu5" class="nav-link"><i class="fa fa-certificate"></i> Alergias & Medicamentos</a>
                <a data-toggle="tab" href="#menu6" class="nav-link"><i class="fa fa-certificate"></i> Historial Psiquiatrico</a>
                <a data-toggle="tab" href="#menu7" class="nav-link"><i class="fa fa-certificate"></i> Examen Mental</a>
                <a data-toggle="tab" href="#menu8" class="nav-link"><i class="fa fa-certificate"></i> Impresion Diagnostica</a>
            </nav>
        </div>
...
<div class="form-row">
<div class="form-check col-md-12">
      <input type="checkbox" name="cmp_ninguna" value="ninguna" <?php echo (($data['cmp_ninguna'] =="ninguna") ? "checked" : "");?>>
      <label for="inputPassword4">Ninguna </label><br>
      <input type="checkbox" name="cmp_psicosis" value="psicosis" <?php echo (($data['cmp_psicosis'] =="psicosis") ? "checked" : "");?>>
      <label for="inputPassword4"> Psicosis</label><br>
      <input type="checkbox" name="cmp_tras_bipo" value="tras_bipo" <?php echo (($data['cmp_tras_bipo'] =="tras_bipo") ? "checked" : "");?>>
      <label for="inputPassword4"> Trastorno Bipolar</label><br>
      <input type="checkbox" name="cmp_tras_depr" value="tras_depr" <?php echo (($data['cmp_tras_depr'] =="tras_depr") ? "checked" : "");?>>
      <label for="inputPassword4"> Trastorno depresivo</label><br>
      <input type="checkbox" name="cmp_tras_ansi" value="tras_ansi" <?php echo (($data['cmp_tras_ansi'] =="tras_ansi") ? "checked" : "");?>>
      <label for="inputPassword4"> Trastorno de Ansiedad</label><br>
      <input type="checkbox" name="cmp_tras_por" value="tras_por" <?php echo (($data['cmp_tras_por'] =="tras_por") ? "checked" : "");?>>
      <label for="inputPassword4"> Trastorno por uso de Alcohol o Sustancias</label><br>
      <input type="checkbox" name="cmp_other" value="other" <?php echo (($data['cmp_other'] =="other") ? "checked" : "");?>>
      <label for="inputPassword4"> Other</label>
<textarea class="col-md-12" rows="3" name="cmp_other_cmnt"><?php echo $data['cmp_other_cmnt']; ?></textarea><br>
</div>
...
<select name="apariencia" class="form-control">
      ...
      <option value="Desaliñado" <?php echo (($data['apariencia'] == "Desaliñado") ? "selected" : "")?>>Desaliñado</option>
      <option value="Nítida" <?php echo (($data['apariencia'] == "Nítida") ? "selected" : "")?>>Nítida</option>
      <option value="Nítido" <?php echo (($data['apariencia'] == "Nítido") ? "selected" : "")?>>Nítido</option>
...
<td><select name="actividadm" class="form-control">
      ...
      <option value="Agitada" <?php echo (($data['actividadm'] == "Agitada") ? "selected" : "")?>>Agitada</option>
      <option value="Agitado" <?php echo (($data['actividadm'] == "Agitado") ? "selected" : "")?>>Agitado</option>
      <option value="Temblorosa" <?php echo (($data['actividadm'] == "Temblorosa") ? "selected" : "")?>>Temblorosa</option>
      <option value="Tembloroso" <?php echo (($data['actividadm'] == "Tembloroso") ? "selected" : "")?>>Tembloroso</option>
      <option value="Paciente encamada" <?php echo (($data['actividadm'] == "Paciente encamada") ? "selected" : "")?>>Paciente encamada</option>
      <option value="Paciente encamado" <?php echo (($data['actividadm'] == "Paciente encamado") ? "selected" : "")?>>Paciente encamado</option>
      ...
      <option value="Ambula por sí solo" <?php echo (($data['actividadm'] == "Ambula por sí solo") ? "selected" : "")?>>Ambula por sí solo</option>
...
<option value="Cooperador"  <?php echo (($data['actitud']=="Cooperador") ? "selected" : "")?>>Cooperador</option>
...
<option value="Agresivo"  <?php echo (($data['actitud']=="Agresivo") ? "selected" : "")?>>Agresivo</option>
<option value="Reservada"  <?php echo (($data['actitud']=="Reservada") ? "selected" : "")?>>Reservada</option>
<option value="Reservado"  <?php echo (($data['actitud']=="Reservado") ? "selected" : "")?>>Reservado</option>
<option value="Desconfiada"  <?php echo (($data['actitud']=="Desconfiada") ? "selected" : "")?>>Desconfiada</option>
<option value="Desconfiado"  <?php echo (($data['actitud']=="Desconfiado") ? "selected" : "")?>>Desconfiado</option>
<option value="Desinteresada"  <?php echo (($data['actitud']=="Desinteresada") ? "selected" : "")?>>Desinteresada</option>
<option value="Desinteresado"  <?php echo (($data['actitud']=="Desinteresado") ? "selected" : "")?>>Desinteresado</option>
...
<option value="Lució tranquilo durante la evaluación"  <?php echo (($data['conducta']=="Lució tranquilo durante la evaluación") ? "selected" : "")?>>Lució tranquilo durante la evaluación</option>
...
<option value="Lució intranquilo durante la evaluación"  <?php echo (($data['conducta']=="Lució intranquilo durante la evaluación") ? "selected" : "")?>>Lució intranquilo durante la evaluación</option>
<option value="Desorganizada"  <?php echo (($data['conducta']=="Desorganizada") ? "selected" : "")?>>Desorganizada</option>
<option value="Desorganizado"  <?php echo (($data['conducta']=="Desorganizado") ? "selected" : "")?>>Desorganizado</option>
...
<option value="Se muestra combativo o con dificultad en controlar impulsos"  <?php echo (($data['conducta']=="Se muestra combativo o con dificultad en controlar impulsos") ? "selected" : "")?>>Se muestra combativo o con dificultad en controlar impulsos</option>
...
<option value="Claro"  <?php echo (($data['habia']=="Claro") ? "selected" : "")?>>Claro</option>
<option value="Disártrica"  <?php echo (($data['habia']=="Disártrica") ? "selected" : "")?>>Disártrica</option>
<option value="Disártrico"  <?php echo (($data['habia']=="Disártrico") ? "selected" : "")?>>Disártrico</option>
<option value="Mínima"  <?php echo (($data['habia']=="Mínima") ? "selected" : "")?>>Mínima</option>
<option value="Mínimo"  <?php echo (($data['habia']=="Mínimo") ? "selected" : "")?>>Mínimo</option>
...
<option value="Pausado"  <?php echo (($data['habia']=="Pausado") ? "selected" : "")?>>Pausado</option>
<option value="Apresurada"  <?php echo (($data['habia']=="Apresurada") ? "selected" : "")?>>Apresurada</option>
<option value="Apresurado"  <?php echo (($data['habia']=="Apresurado") ? "selected" : "")?>>Apresurado</option>
...
<option value="Estropajoso"  <?php echo (($data['habia']=="Estropajoso") ? "selected" : "")?>>Estropajoso</option>
...
<option value="Eutímica"  <?php echo (($data['talante']=="Eutímica") ? "selected" : "")?>>Eutímica</option>
<option value="Eutímico"  <?php echo (($data['talante']=="Eutímico") ? "selected" : "")?>>Eutímico</option>
<option value="Deprimida"  <?php echo (($data['talante']=="Deprimida") ? "selected" : "")?>>Deprimida</option>
<option value="Deprimido"  <?php echo (($data['talante']=="Deprimido") ? "selected" : "")?>>Deprimido</option>
<option value="Expansiva"  <?php echo (($data['talante']=="Expansiva") ? "selected" : "")?>>Expansiva</option>
<option value="Expansivo"  <?php echo (($data['talante']=="Expansivo") ? "selected" : "")?>>Expansivo</option>
<option value="Ansiosa"  <?php echo (($data['talante']=="Ansiosa") ? "selected" : "")?>>Ansiosa</option>
...
<option value="Completamente orientado"  <?php echo (($data['orientacion']=="Completamente orientado") ? "selected" : "")?>>Completamente orientado</option>
...
<option value="Parcialmente orientado"  <?php echo (($data['orientacion']=="Parcialmente orientado") ? "selected" : "")?>>Parcialmente orientado</option>
...
<option value="Orientado sólo en persono"  <?php echo (($data['orientacion']=="Orientado sólo en persono") ? "selected" : "")?>>Orientado sólo en persono</option>
...
<option value="Totalmente desorientado"  <?php echo (($data['orientacion']=="Totalmente desorientado") ? "selected" : "")?>>Totalmente desorientado</option>
