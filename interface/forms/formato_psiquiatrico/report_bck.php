...
if($data['cmp_ninguna'] != '' || $data['cmp_psicosis'] != '' || $data['cmp_tras_bipo'] != '' || $data['cmp_tras_depr'] != '' || $data['cmp_tras_ansi'] != '' || $data['cmp_tras_por'] != '' || $data['cmp_other'] != '' || $data['cmp_other_cmnt'] != ''){
	print '<div class="form-group col-md-12">
<b>Condiciones Médicas Psiquiátricas:</b><br>';
echo (($data['cmp_ninguna'] =="ninguna") ? "Ninguna<br>" : "");
echo (($data['cmp_psicosis'] =="psicosis") ? "Psicosis<br>" : "");
echo (($data['cmp_tras_bipo'] =="tras_bipo") ? "Trastorno Bipolar<br>" : "");
echo (($data['cmp_tras_depr'] =="tras_depr") ? "Trastorno depresivo<br>" : "");
echo (($data['cmp_tras_ansi'] =="tras_ansi") ? "Trastorno de Ansiedad<br>" : "");
echo (($data['cmp_tras_por'] =="tras_por") ? "Trastorno por uso de Alcohol o Sustancias<br>" : "");
echo (($data['cmp_other'] =="other") ? "Other - ".$data['cmp_other_cmnt']."<br>" : "");
print '</div>';
}
