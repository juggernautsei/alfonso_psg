...
//print_r($_POST);die();
 ...
 if($mode == 'new')
 {
	 $newid = formSubmit('form_reevaluacion_psicologica_interna', $_POST, $_GET["id"], $userauthorized);
    addForm($encounter, "Reevaluacion Psicologica Interna", $newid, "reevaluacion_psicologica_interna", $pid, $userauthorized);
...
formUpdate('form_reevaluacion_psicologica_interna', $_POST, $_GET["id"], $userauthorized);
        //$mylab_id = lab_orders($gf_id,$user,$pid,$encounter);
