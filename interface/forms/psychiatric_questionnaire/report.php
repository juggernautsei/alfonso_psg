...
function psychiatric_questionnaire_report($pid, $encounter, $cols, $id)
{
	$res = sqlStatement("select * from form_psychiatric_questionnaire where pid=? and id=?", array($pid,$id));
