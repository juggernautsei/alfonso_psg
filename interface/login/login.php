...
<body class="login">
  <form method="POST" id="login_form" autocomplete="off" action="../main/main_screen.php?auth=login&site=<?php echo attr($_SESSION['site_id']); ?>" target="_top" name="login_form">
      <div class="<?php echo $loginrow; ?>" style="max-width:700px;">
          ...
          <div class="<?php echo $logoarea; ?>" style="padding-top: 14em !important">
            ...
            <?php } else { ?>
	      <div class="mx-auto m-4 w-100 text-center">
<img class="img-fluid img-responsive center-block" src="/public/images/login-logo.png">
