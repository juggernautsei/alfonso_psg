...
if (isset($_POST["privatemode"]) && $_POST["privatemode"] == "user_admin") {
    if ($_POST["mode"] == "update") {
        ...
        if ($_POST["bn"]) {
            sqlStatement("update users set bn=? where id= ? ", array($_POST["bn"], $_POST["id"]));
        }
        if ($_POST["dm"]) {
            sqlStatement("update users set dm=? where id= ? ", array($_POST["dm"], $_POST["id"]));
        }
        if ($_POST["lic"]) {
            sqlStatement("update users set lic=? where id= ? ", array($_POST["lic"], $_POST["id"]));
        }
...
if (isset($_POST["mode"])) {
    if ($_POST["mode"] == "new_user") {
        ...
        if ($doit == true) {
            ...
            "', bn = '"         . add_escape_custom(trim((isset($_POST['bn']) ? $_POST['bn'] : ''))) .
            "', dm = '"         . add_escape_custom(trim((isset($_POST['dm']) ? $_POST['dm'] : ''))) .
            "', lic = '"         . add_escape_custom(trim((isset($_POST['lic']) ? $_POST['lic'] : ''))) .
