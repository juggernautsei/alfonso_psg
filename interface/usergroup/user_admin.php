...
<tr>
<td><span class="text"><?php echo xlt('LIC'); ?>: </span></td>
<td><input type="text" name="lic" style="width:150px;" class="form-control" value="<?php echo attr($iter["lic"]); ?>"></td>
</tr>
...
<td><span class="text"><?php echo xlt('DM'); ?>: </span></td>
<td><input type="text" name="dm" style="width:150px;" class="form-control" value="<?php echo attr($iter["dm"]); ?>"></td>
</tr>
...
<td><span class="text"><?php echo xlt('BN'); ?>: </span></td>
<td><input type="text" name="bn" style="width:150px;" class="form-control" value="<?php echo attr($iter["bn"]); ?>"></td>
</tr>
<tr>
  <td>
