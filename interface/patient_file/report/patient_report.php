...
<br>
<br>
			Email To: <input type='text' name='email_to[]' value='' size="40"/>
			<button type="button" class="genemailrep btn btn-primary btn-email btn-sm" value="<?php echo xla('Send Email'); ?>" ><?php echo xlt('Send Email'); ?></button>
<br><p>Note: multiple emails with comma separated values</p>
                        ...
                        <div class="row issues_encounters_forms">
                            ...
                            <div class="col-md-6">
                                ...
                                <button type="button" class="genreport btn btn-primary btn-save btn-sm" value="<?php echo xla('Generate Report'); ?>" ><?php echo xlt('Generate Report'); ?></button>
				<button type="button" class="genpdfrep btn btn-primary btn-download btn-sm" value="<?php echo xla('Download PDF'); ?>" ><?php echo xlt('Download PDF'); ?></button><br>
<br>
			Email To: <input type='text' name='email_to[]' value='' size="40"/>
                                <button type="button" class="genemailrep btn btn-primary btn-email btn-sm" value="<?php echo xla('Send Email'); ?>" ><?php echo xlt('Send Email'); ?></button>
<br><p>Note: multiple emails with comma separated values</p>
...
$(function () {
    ...
    $(".genemailrep").click(function() { top.restoreSession(); document.report_form.pdf.value = 1; document.report_form.email.value = 1;
   var values = [];
    $("input[name='email_to[]']").each(function() {
	    if($(this).val() != ''){
		    values.push($(this).val());
	    }
});
document.report_form.email_address.value = values.join(',');
    $("#report_form").submit(); });
