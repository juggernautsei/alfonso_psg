        ...
        if (substr($formdir, 0, 3) == 'LBF') {
          // A link for a nice printout of the LBF
            ...
            "' onclick='top.restoreSession()'>" . xlt('Print') . "</a>";
               ...
               echo "<a target='_blank' " .
            "href='$rootdir/patient_file/report/custom_report.php?printable=1&pdf=0&include_demographics=demographics&".$formdir."_".$iter['form_id']."=".$encounter.
            "' class='btn btn-primary btn-sm' title='" . xl('Print this form') .
           "' onclick='top.restoreSession()'><span>" . xlt('Print') . "</span></a>";
	}
//	echo "<a target='_blank' " .
//            "href='mailto:?subject=your%20subject&amp;body=your%20body&attachment=C:/Users/saranya/Documents/VIGNESH%20THANGAVEL.pdf' class='btn btn-primary btn-sm' title='" . xl('send email') .
  //         "' onclick='top.restoreSession()'><span>" . xlt('Email') . "</span></a>";
